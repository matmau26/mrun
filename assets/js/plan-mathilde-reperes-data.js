window.PLAN_MATHILDE_REPERES = {
  ...
  "tableau_pilotage": {
    ...
    "lignes": [
      {
        "cle": "ef",
        "intention": "EF / footing",
        "sous_titre": "Endurance fondamentale",
        "allure": "5:30 – 6:00 /km",
        "allure_note": null,
        "fc": "138 – 155",
        "fc_note": null,
      ...
      {
        "cle": "endurance_active",
        "intention": "Endurance active",
        "sous_titre": "Tempo bas",
        "allure": "5:05 – 5:20 /km",
        "allure_note": null,
        "fc": "156 – 170",
        "fc_note": null,
      ...
      {
        "cle": "allure_course",
        "intention": "Allure SaintéSprint",
        "sous_titre": "L'allure de la course",
        "allure": "4:52 – 5:00 /km",
        "allure_note": "5:04 – 5:12 sur le parcours",
        "fc": "176 – 182",
        "fc_note": "180 tenus 2 h 05 en 2025",
        "watts": "157 – 165 W",
        "pct_cp": "88 – 92 %",
        "zone_fc": "Z4",
        "zone_stryd": "Z2 → Z3",
      ...
      {
        "cle": "allure_10k",
        "intention": "Allure 10 km",
        "sous_titre": "~45 minutes d'effort",
        "allure": "4:22 – 4:32 /km",
        "allure_note": null,
        "fc": "182 – 188",
        "fc_note": null,
      ...
      {
        "cle": "allure_5k",
        "intention": "Allure 5 km",
        "sous_titre": "VMA longue",
        "allure": "4:05 – 4:15 /km",
        "allure_note": null,
        "fc": "186 – 190",
        "fc_note": null,
      ...
      {
        "cle": "vma_courte",
        "intention": "VMA courte",
        "sous_titre": "Travail de foulée",
        "allure": "3:48 – 4:00 /km",
        "allure_note": null,
        "fc": "libre",
        "fc_note": "elle n'a pas le temps de monter",
        "watts": "215 – 233 W",
        "pct_cp": "120 – 130 %",
        "zone_fc": "Z6",
        "zone_stryd": "Z5",
  ...
  "zones_fc": {
    "base": "LTHR estimé 185 (fourchette 183-188). Zones calées sur le LTHR et vérifiées contre 62 séances réelles depuis le 01/06/2026. La montre est paramétrée sur ces mêmes valeurs — FC de repos 59 (moyenne), seuil lactique 185, FC maximale 190, affichage en BPM — et montre donc les mêmes bornes que ce tableau.",
    "liste": [
      {
        "zone": "Z1",
        "nom": "Récupération",
      ...
      },
      {
        ...
        "pct_lthr": "75 – 84 %",
        "intensite": 1,
        "usage": "Tous les footings — 70 % du volume"
      },
      {
        "zone": "Z3",
    ...
    "liste": [
      {
        ...
        "w_kg": "2,47 – 3,04",
        "intensite": 1,
        "usage": "Footings faciles, sorties longues, volume de base"
      },
      {
        "zone": "Z2",
        "nom": "Modéré",
        ...
        "w_kg": "3,04 – 3,43",
        "intensite": 2,
        "usage": "Tempo et simulation d'allure course"
      },
      {
        "zone": "Z3",
        "nom": "Seuil",
        ...
        "w_kg": "3,43 – 3,81",
        "intensite": 3,
        "usage": "Intervalles longs, blocs de seuil, séances 10 km"
      },
      {
        "zone": "Z4",
        "nom": "Intervalle",
        ...
        "w_kg": "3,81 – 4,38",
        "intensite": 4,
        "usage": "Intervalles, travail 5 km"
      },
      {
        "zone": "Z5",
        "nom": "Répétition",
        ...
        "w_kg": "4,38 +",
        "intensite": 5,
        "usage": "Intervalles courts, sprints, piste rapide"
      }
    ]
  }
}
